...
export default function Hero({
  ...
  return (
    <section className="relative overflow-x-clip bg-gradient-to-b from-blue-kimono to-ink text-white">
      <div className="mx-auto max-w-5xl px-4 py-20 text-center sm:py-28 sm:text-left">
        <div className="sm:max-w-lg">
          ...
          <img
            ...
            width={360}
            height={360}
            className="mx-auto h-24 w-24 sm:hidden"
          />
          ...
          <p className="mx-auto mt-4 max-w-2xl text-white/70 sm:mx-0 sm:max-w-none">
      ...
      {/* eslint-disable-next-line @next/next/no-img-element -- decorative oversized logo, basePath-aware src */}
      <img
        src={assetPath("/images/logo.png")}
        alt=""
        aria-hidden="true"
        width={380}
        height={380}
        className="pointer-events-none absolute bottom-0 right-8 hidden h-[clamp(160px,26vw,380px)] w-[clamp(160px,26vw,380px)] translate-y-[30%] rotate-[15deg] drop-shadow-xl sm:block"
      />
    </section>
  );
}
